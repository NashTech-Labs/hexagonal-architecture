...
import com.knoldus.common.command.{CreateNewOrder, FixCreateNewOrder}
...
object ModelMapper {
  ...
  def mapNewOrderSingleToCreateNewOrder(newOrderSingle: NewOrderSingle): FixCreateNewOrder = {
